public class Part3 {
    ...
    public void testCountGenes(){
        String test1 = "xxxATGyyyxxxyyyTAAxyyATGxxxTGAxTGATGxyxTAGxATAATGxyxTGA";
        String test2 = "xyyyyxxxxTAAxTGAxyxTAG";
        
        System.out.println("1: " +  countGenes("ATGTAAGATGCCCTAGT") + "\n");
        System.out.println("2: " +  countGenes(test1) + "\n");
        System.out.println("3: " +  countGenes(test2) + "\n");
    }
}
